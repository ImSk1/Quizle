...
namespace Quizle.Core.UnitTests.Common
{
	public class DataStorage
	{
		...
		private void SetValues()
		{
			...
			{
				new BadgeDto(){Id = 1, Name = "Badge1", Description = "Description",  Rarity = "Rare", Price = 5, Image = new byte[0]},
				new BadgeDto(){Id = 2, Name = "Badge2", Description = "Description",  Rarity = "Rare", Price = 5, Image = new byte[0]},
				new BadgeDto(){Id = 3, Name = "Badge3", Description = "Description",  Rarity = "Rare", Price = 5, Image = new byte[0]},
				new BadgeDto(){Id = 4, Name = "Badge4", Description = "Description",  Rarity = "Rare", Price = 5, Image = new byte[0] },
			};
